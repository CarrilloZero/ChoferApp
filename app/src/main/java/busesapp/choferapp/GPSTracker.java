...
/**
 * Created by Juan JP Zamorano on 19-07-2016.
 */
public class GPSTracker extends Service implements LocationListener {
    ...
    class Sender extends AsyncTask<String, Object, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                URL url = new URL("http://192.168.1.7/Usuario/Actualizar?longitud=" + strings[0] + "&latitud=" + strings[1]);
    ...
    protected void showCurrentLocation(View view) {
        ...
        for (Account account : accounts) {
            ...
            if (location != null) {
                new Sender().execute(String.valueOf(location.getLongitude()), String.valueOf(location.getLatitude()), correo, String.valueOf(online));
            }
